# OpenLMIS PCMT Integration UI Module
This repository is the UI for the [PCMT Integration Service.](https://github.com/OpenLMIS-COVID/pcmt-integration)
...
1. Fork/clone this repository from GitHub.
 ...
 ```shell
> git clone https://github.com/OpenLMIS-COVID/pcmt-integration-ui.git
> cd pcmt-integration-ui/
 ```
2. Create a .env file, which can be used to overwrite 'sensitive' settings from config.json
```shell
> touch .env
```
3. Develop w/ Docker by running `docker-compose run --service-ports pcmt-integration-ui`.
...
### need to uptade bottom point. 
6. Remember to Add rights to PCMT Integration. You can do it by execute [SQL File](https://github.com/OpenLMIS-COVID/pcmt-integration/blob/master/src/scripts/pcmt_integration_rights.sql) on your RDS instance.
...
> docker-compose run --service-ports pcmt-integration-ui
...
```shell
> docker-compose pull
> docker-compose run --entrypoint /dev-ui/build.sh pcmt-integration-ui
