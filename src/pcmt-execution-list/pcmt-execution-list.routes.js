...
(function() {
    ...
    function routes($stateProvider) {
        $stateProvider.state('openlmis.administration.pcmt.executions', {
            label: 'pcmt.executions',
            url: '/executions?page&size&sort',
            controller: 'ExecutionListController',
            templateUrl: 'pcmt-execution-list/pcmt-execution-list.html',
            controllerAs: 'vm',
            resolve: {
                ...
                periods: function(executions, queueItems) {
