...
(function() {
    ...
    /**
     * @ngdoc controller
     * @name pcmt-execution-response-body:ExecutionResponseBodyController
     *
     * @description
    ...
    function controller($state, execution, $filter) {
        ...
        /**
         * @ngdoc property
         * @propertyOf pcmt-execution-response-body:ExecutionResponseBodyController
         * @name execution
         * @type {Array}
         *
        ...
        /**
         * @ngdoc method
         * @methodOf pcmt-execution-response-body:ExecutionResponseBodyController
