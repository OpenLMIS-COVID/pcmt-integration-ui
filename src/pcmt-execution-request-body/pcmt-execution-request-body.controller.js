...
(function() {
    ...
    /**
     * @ngdoc controller
     * @name pcmt-execution-request-body:ExecutionRequestBodyController
     *
     * @description
    ...
    function controller($state, requestbody) {
        ...
        /**
         * @ngdoc property
         * @propertyOf pcmt-execution-request-body:ExecutionRequestBodyController
         * @name requestbody
         * @type {Array}
         *
        ...
        /**
         * @ngdoc method
         * @methodOf pcmt-execution-request-body:ExecutionRequestBodyController
