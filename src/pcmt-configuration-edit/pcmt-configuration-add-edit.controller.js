...
(function() {
    ...
    /**
     * @ngdoc controller
     * @name pcmt-configuration-add-edit-general:ConfigurationAddEditController
     *
     * @description
     * Controller for managing configuration view screen.
     */
    angular
        .module('pcmt-configuration-edit')
    ...
    function controller($state, configuration, ConfigurationResource, notificationService) {
        ...
        /**
         * @ngdoc method
         * @propertyOf pcmt-configuration-add-edit-general:ConfigurationAddEditController
         * @name $onInit
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @methodOf pcmt-configuration-add-edit-general:ConfigurationAddEditController
        ...
        function goToConfigurationList(reload) {
            $state.go('openlmis.administration.pcmt.configurations', {}, {
                reload: reload
            });
        }
        ...
        function saveConfiguration() {
            if (vm.configuration.id) {
                return new ConfigurationResource()
                    ...
                    .then(function() {
                        notificationService.success('pcmtConfigurationEdit.configurationEditSuccessfully');
                    });
            }
            return new ConfigurationResource()
                ...
                .then(function() {
                    notificationService.success('pcmtConfigurationEdit.configurationAddSuccessfully');
                });
        }
