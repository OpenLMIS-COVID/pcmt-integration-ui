...
(function() {
    ...
    /**
     * @ngdoc controller
     * @name pcmt-configuration-list:ConfigurationListController
     *
     * @description
     * Controller for configuration list view screen.
     */
    angular
        .module('pcmt-configuration-list')
    ...
    function controller($state, $stateParams, $q, ConfigurationResource,
        ...
        /**
         * @ngdoc method
         * @propertyOf pcmt-configuration-list:ConfigurationListController
         * @name $onInit
         *
         * @description
        ...
        function deleteConfiguration(configuration) {
            return confirmService
                .confirmDestroy('pcmtConfigurationList.delete.confirm', 'pcmtConfigurationList.delete')
                .then(function() {
                ...
                .then(function() {
                    notificationService.success('pcmtConfigurationList.configurationDeletedSuccessfully');
                })
        ...
        function refreshState(stateParams) {
            $state.go('openlmis.administration.pcmt.configurations', stateParams, {
                reload: true
            });
            notificationService.success('pcmtConfigurationEdit.pageHasBeenRefreshed');
        }
